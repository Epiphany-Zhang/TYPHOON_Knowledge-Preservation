...
function SourceFigure(props: { src: string; caption: string; alt?: string }) {
  ...
  return (
    <figure className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
      <img src={src} alt={alt ?? 'source'} className="object-cover w-full h-52 sm:h-56" />
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-2">
        <SourceFigure
          src="https://pub-cdn.sider.ai/u/U0L5HAOE6JV/web-coder/68e72512b54d8be52ac19385/resource/199d288c-3806-49c5-83a5-0cb6f46e3582.jpg"
          alt="light building under blue sky"
          caption="本作品用于地学科普教学与公众传播，欢迎非商业使用与二次创作（请注明来源）。"
        />
        <SourceFigure
          src="https://pub-cdn.sider.ai/u/U0L5HAOE6JV/web-coder/68e72512b54d8be52ac19385/resource/07beffd6-c724-4f88-9ec6-94364b3876db.jpg"
