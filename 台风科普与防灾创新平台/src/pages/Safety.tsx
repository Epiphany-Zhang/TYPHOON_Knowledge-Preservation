  ...
  const hazards: SafetyPoint[] = useMemo(() => [
    {
      ...
      icon: AlertTriangle,
      accent: 'amber',
      image: 'https://pub-cdn.sider.ai/u/U0L5HAOE6JV/web-coder/68e72512b54d8be52ac19385/resource/fd34f7c9-3634-45a7-8665-ea1a65881508.png',
    },
    {
      title: '高空坠物与玻璃破损',
      desc:
      ...
      icon: AlertTriangle,
      accent: 'amber',
      image: 'https://pub-cdn.sider.ai/u/U0L5HAOE6JV/web-coder/68e72512b54d8be52ac19385/resource/619a14d5-2b56-48d3-be62-5625ef46fa38.png',
    },
    {
      title: '城市内涝与山洪',
      desc:
      ...
      icon: AlertTriangle,
      accent: 'amber',
      image: 'https://pub-cdn.sider.ai/u/U0L5HAOE6JV/web-coder/68e72512b54d8be52ac19385/resource/61be3980-8535-4c74-919b-3ca977ba0d97.png',
    },
    {
      title: '断电与通信中断',
      desc:
      ...
      icon: AlertTriangle,
      accent: 'amber',
      image: 'https://pub-cdn.sider.ai/u/U0L5HAOE6JV/web-coder/68e72512b54d8be52ac19385/resource/17831bc0-8eb9-4e3a-a294-dde72b279c52.png',
    },
  ], [])
  ...
  const measures: SafetyPoint[] = useMemo(() => [
    {
      ...
      icon: ShieldCheck,
      accent: 'blue',
      image: 'https://pub-cdn.sider.ai/u/U0L5HAOE6JV/web-coder/68e72512b54d8be52ac19385/resource/500b9afb-c79c-446e-959b-790208fadcb3.png',
    },
    {
      title: '应急物资',
      desc:
      ...
      icon: LifeBuoy,
      accent: 'blue',
      image: 'https://pub-cdn.sider.ai/u/U0L5HAOE6JV/web-coder/68e72512b54d8be52ac19385/resource/ae1a3c5d-3e43-4dd6-a272-c6840adeffb5.png',
    },
    {
      title: '行程调整',
      desc:
      ...
      icon: ShieldCheck,
      accent: 'blue',
      image: 'https://pub-cdn.sider.ai/u/U0L5HAOE6JV/web-coder/68e72512b54d8be52ac19385/resource/ea29634f-8c12-4d03-b02c-b30d0aa51854.png',
    },
    {
      title: '信息获取',
      desc:
      ...
      icon: ShieldCheck,
      accent: 'green',
      image: 'https://pub-cdn.sider.ai/u/U0L5HAOE6JV/web-coder/68e72512b54d8be52ac19385/resource/6db155e0-2b78-44c9-abf0-bf4206346ac3.png',
    },
    {
      title: '紧急联络',
      desc:
      ...
      icon: Phone,
      accent: 'blue',
      image: 'https://pub-cdn.sider.ai/u/U0L5HAOE6JV/web-coder/68e72512b54d8be52ac19385/resource/71e1ddc0-47b6-4b89-a236-eba53ec161c1.png',
    },
    {
      title: '避险要点',
      desc:
      ...
      icon: LifeBuoy,
      accent: 'green',
      image: 'https://pub-cdn.sider.ai/u/U0L5HAOE6JV/web-coder/68e72512b54d8be52ac19385/resource/d2a4ac0b-27ed-4ba0-be79-75fd33e5e4e4.png',
    },
  ], [])
      ...
      <section className="relative overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-r from-blue-800 to-slate-700 text-white">
        ...
        <div className="grid md:grid-cols-2 items-start gap-0">
          ...
          <div className="relative hidden md:flex items-center justify-center p-4 md:max-h-[260px] lg:max-h-[320px]">
            <img
              src="https://pub-cdn.sider.ai/u/U0L5HAOE6JV/web-coder/68e72512b54d8be52ac19385/resource/76e87528-c689-45ae-9280-e46f35991733.png"
